	...
	<body class="is-preload">
				...
				<!-- About Me -->
					<section id="about" class="three">
						<div class="container">
							...
							Bordão: Do jeito que você gosta <br>
							A 58 anos no ar <br>
							Rua Abdias Veras Nº 681 - Bairro São Vicente
							Crateús/CE <br>
							Superintendente Dr. Lourival Rodrigues <br>
							Rádio Jornalística <br>
							Estulo musical eclético <br>
							Radiosnet: Rádio Educadora AM1250 <br>
							App PlayStore: Nova Educadpra de Crateús <br>
							Demais aplicativos de rádio: Rádio Educadora de Crateús </p>
		...
		<!-- Footer -->
			<div id="footer">
				...
				<!-- Copyright -->
					<ul class="copyright">
						<li>&copy; Todos os direitos reservados.</li><li>Design: <a href="https://www.instagram.com/luansantos_kr/">Luan Santos</a></li>
					</ul>
